...
$string['logoorsitenamedesc'] = 'Możesz zmienić logo nagłówka witryny zgodnie z własnym wyborem. <br /> Dostępne opcje to: Tylko logo - wyświetlone zostanie tylko logo; <br /> Nazwa strony - zostanie wyświetlona tylko nazwa strony; <br /> Ikona + nazwa strony - Wyświetli się ikona wraz z nazwą witryny.';
