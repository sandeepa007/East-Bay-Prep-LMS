...
//require_once($CFG->dirroot . '/mod/quiz/accessrule/gradebycategory/overview_table_with_category_totals.php');//by me -remove above cmnt
...
class quiz_overview_report extends quiz_attempts_report {
 ...
 //$table = new quiz_overview_table_with_category_totals($quiz, $this->context, $this->qmsubselect,
   //             $options, $groupstudentsjoins, $studentsjoins, $questions, $options->get_url());//by me- remove above two cmnt
