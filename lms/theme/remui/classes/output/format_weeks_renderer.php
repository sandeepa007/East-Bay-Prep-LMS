...
class format_weeks_renderer extends \format_weeks_renderer {
    ...
    protected function section_header($section, $course, $onsectionpage, $sectionreturn = null)
    {
        ...
        $temp  = '<a href="#sectionwrapper-'.$section->section.'">'.get_section_name($section->course, $section).'</a>';
        if (!empty($cm_list)) {
            $temp  = '<a href="#sectionwrapper-'.$section->section.'">'.get_section_name($section->course, $section).'<i class="fa-angle-up float-right"></i></a>';
        }
