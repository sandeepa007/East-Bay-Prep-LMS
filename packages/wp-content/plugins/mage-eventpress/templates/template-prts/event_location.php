...
<p><?php echo $event_meta['mep_location_venue'][0]; ?>,</p>
					<p><?php echo $event_meta['mep_street'][0]; ?>,</p>
					<p><?php echo $event_meta['mep_city'][0]; ?>,</p>
					<p><?php echo $event_meta['mep_state'][0]; ?>,</p> 
					<p><?php echo $event_meta['mep_postcode'][0]; ?>,</p>
					<p><?php echo $event_meta['mep_country'][0]; ?></p>
<?php
}
