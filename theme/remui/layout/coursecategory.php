...
$CSparam = explode('_',$categorysort);
$courses    = \theme_remui\utility::get_courses(false, $search, $category, 0, $courseperpage, 0, $CSparam[1]);
...
if (isloggedin() && !isguestuser()) {
    ...
    $my_courses    = \theme_remui\utility::get_courses(false, $search, $category, $startmyfrom, $courseperpage, 1, $CSparam[1]);
