...
class course_renderer extends \core_course_renderer
{
    ...
    public function course_section_cm_list($course, $section, $sectionreturn = null, $displayoptions = array())
    {
        ...
        if (!empty($sectionoutput) && ($course->format == "topics" || $course->format == "weeks")) {
            $output .= html_writer::tag('ul', $sectionoutput, array('class' => 'section img-text p-0 list-group list-group-dividered list-group-full'));
        }
        else {
            $output .= html_writer::tag('ul', $sectionoutput, array('class' => 'section img-text list-group-dividered'));
        }
    ...
    public function course_section_cm_list_item($course, &$completioninfo, cm_info $mod, $sectionreturn, $displayoptions = array())
    {
        ...
        if ($modulehtml = $this->course_section_cm($course, $completioninfo, $mod, $sectionreturn, $displayoptions)) {
            $modclasses = 'activity ' . $mod->modname . ' modtype_' . $mod->modname . 'list-group-item' . $mod->extraclasses;
