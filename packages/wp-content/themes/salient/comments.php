...
?>
<div class="comment-wrap <?php echo $fw_class;?>" data-midnight="dark" data-comments-open="<?php echo $comments_open_attr; ?>">

<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php  if(!empty($options['theme-skin']) && $options['theme-skin'] == 'ascend') echo '<span><i>'. __("Join the discussion", 'salient').'</i></span>' ?> <?php comments_number(__('No Comments','salient'), __('One Comment', 'salient'), __('% Comments', 'salient') );?></h3>
...
$comment_label = ($form_style == 'minimal') ? '<label for="comment">' . __('My comment is..', 'salient') . '</label>' : null;
