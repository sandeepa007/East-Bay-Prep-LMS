...
<?php if(function_exists('wc_get_loop_prop')) { ?>
  <ul class="products columns-<?php echo esc_attr( wc_get_loop_prop( 'columns' ) );?>" data-n-desktop-columns="<?php echo $nectar_woo_desktop_cols; ?>" data-n-desktop-small-columns="<?php echo $nectar_woo_desktop_small_cols; ?>" data-n-tablet-columns="<?php echo $nectar_woo_tablet_cols; ?>" data-n-phone-columns="<?php echo $nectar_woo_phone_cols; ?>" data-product-style="<?php echo $product_style; ?>">
<?php } else { ?>
