...
//        $posted_data['username']    = self::getPostedField('username');
    ...
    public function getUserAccountNavigationItems()
    {
        return apply_filters(
            ...
            array(
                array(
                'label' => __('My Accounts', "eb-textdomain"),
                'href'  => '',
                ''      => __('My Accounts', "eb-textdomain"),
            ),
            array(
            ...
            array(
                ...
                'href'  => 'eb-orders',
                ''      => __('Course and class sessions purchase history', "eb-textdomain"),
            ),
            array(
             ...
             array(
                'label' => __('My Sessions', "eb-textdomain"),
                'href'  => 'eb-my-sessions',
                ''      => __('My Sessions', "eb-textdomain"),
            )
                )
        );
    }
